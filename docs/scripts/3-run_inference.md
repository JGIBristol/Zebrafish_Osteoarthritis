...
> Change it to your actual mount point to get these to work
...
```
uv run scripts/3-run_inference.py locator my_cool_model ~/my_rdsf_mount/DATABASE/uCT/Wahab_clean_dataset/TIFS/ak_1.tif --output-dir 3d_tif_example
```

#### Run on a stack of 2D TIF images
```
uv run scripts/3-run_inference.py locator my_cool_model ~/my_rdsf_mount/DATABASE/uCT/Wahab_clean_dataset/low_res_clean_v3/040/reconstructed_tifs/ --two-d-images --output-dir 2d_stack_example
```

#### Run on several 3D TIF images
```
uv run scripts/3-run_inference.py locator my_cool_model ~/my_rdsf_mount/DATABASE/uCT/Wahab_clean_dataset/TIFS/ --output-dir several_tifs_example
```

#### Run on several 3D TIF images, using a text file to specify paths
```
uv run scripts/3-run_inference.py locator my_cool_model my_inputs.txt --output-dir 3d_tifs_from_txt_example
```
<details>
...
```
uv run scripts/3-run_inference.py locator my_cool_model my_inputs.txt --output-dir 2d_tifs_from_txt_example --two-d-images
```
<details>
<summary>my_inputs.txt</summary>
...
~/my_rdsf_mount/DATABASE/uCT/Wahab_clean_dataset/low_res_clean_v3/041/reconstructed_tifs/
~/my_rdsf_mount/DATABASE/uCT/Wahab_clean_dataset/low_res_clean_v3/042/reconstructed_tifs/
```
</details>
