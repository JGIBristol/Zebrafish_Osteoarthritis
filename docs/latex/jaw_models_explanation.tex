...
What the U-Net looks like
\subsection{Patch-based Training}
Why split into patches: generalises better, might mean it works on the whole scan
\subsection{Model Output}
Probabilities, which we threshold + clean up
\begin{figure}
...
Model Ensemble, Ablation study

\subsection{Density Analysis}
Greyscale analysis, feature selection, find muscle attachments

\subsection{Shape Analysis}
fine-tuning on other bones, Auto mesh, Shapeworks, multimodal model for multiple bones,
