"""
Define the model used for jaw segmentation.

Also contains the training loop and inference code.
...
class ModelState:
    ...
    # We keep it here so we know exactly what config was used to train the model
    config: dict[str, Any]
