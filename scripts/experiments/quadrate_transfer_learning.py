...
from fishlib.model import model
from fishlib.transfer import data, transfer_utils
from fishlib.images import metrics
from fishlib.model.data import DataConfig, get_patch_size
from fishlib.visualisation import training, images_3d, plot_meshes
from fishlib.inference import mesh
...
def train(*, epochs: int, **kwargs):
    ...
    torch.save(
        ...
        out_dir / "fresh_quadrate_model.pkl",
    )
