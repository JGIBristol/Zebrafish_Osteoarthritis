...
from fishlib.model import model, data
from fishlib.util import files
from fishlib.inference import read, mesh
from fishlib.visualisation import plot_meshes
...
def main(args: argparse.Namespace):
    ...
    if args.subject is None:
        raise ValueError(
            "Test subject not implemented (for some reason)"
            "please specify a subject, e.g.\n\tuv run scripts/experiments/ablation_study.py 273 example_segmenter.pkl"
        )
